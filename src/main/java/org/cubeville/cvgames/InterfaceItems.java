...
public final class InterfaceItems {
    public static final ItemStack QUEUE_LEAVE_ITEM = GameUtils.customItem(Material.RED_BED, "§c§l§oLeave Queue §7§o(Right Click)");
    public static final ItemStack SPECTATE_LEAVE_ITEM = GameUtils.customItem(Material.RED_BED, "§c§l§oLeave §7§o(Right Click)");
    public static final ItemStack SPECTATE_PLAYER_NAV_ITEM = GameUtils.customItem(Material.COMPASS, "§e§l§oPlayer Compass §7§o(Right Click)");
